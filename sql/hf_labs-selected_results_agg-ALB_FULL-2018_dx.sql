...
DROP TABLE IF EXISTS jjyang.hf_f_lab_alb_2018_pt_dx ;
CREATE TABLE jjyang.hf_f_lab_alb_2018_pt_dx
AS
SELECT DISTINCT
	jjp.patient_id,
	jjl.encounter_id,
...
FROM
	jjyang.hf_f_lab_alb_2018_patients jjp
JOIN
	jjyang.hf_f_lab_alb_2018 jjl ON jjp.patient_id = jjl.patient_id
JOIN
