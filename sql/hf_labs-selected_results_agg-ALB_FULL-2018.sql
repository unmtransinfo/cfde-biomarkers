DROP TABLE IF EXISTS jjyang.hf_f_lab_alb_2018 ;
CREATE TABLE jjyang.hf_f_lab_alb_2018
AS
SELECT DISTINCT
        fe.patient_id,
        fe.encounter_id,
...
WHERE
        ...
        AND dlp.lab_procedure_name ILIKE 'Albumin%serum%'
        AND lab_procedure_group = 'Albumin Test'
