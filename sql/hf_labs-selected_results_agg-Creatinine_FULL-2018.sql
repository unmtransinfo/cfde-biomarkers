...
-- LOINC codes from hf_labs_search_Creatinine.sql and LOINC.org search. 
DROP TABLE IF EXISTS jjyang.hf_f_lab_creatinine_2018 ;
CREATE TABLE jjyang.hf_f_lab_creatinine_2018
AS
SELECT DISTINCT
	fe.patient_id,
	fe.encounter_id,
...
--	AND dlp.loinc_code IN ()
	AND (dlp.lab_procedure_group = 'Creatinine Test, Urine' OR dlp.lab_procedure_name ILIKE '%creatinine%urine%')
