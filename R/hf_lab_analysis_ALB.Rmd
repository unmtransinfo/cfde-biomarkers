---
title: 'Oracle HealthFacts: Laboratory molecular biomarker results analysis: Albumin (ALB) biomarkers'
output:
  html_document:
    df_print: paged
...
Before running this workflow, the following steps are required, in order:
 ...
 - hf_labs-selected_results_agg-ALB_FULL-2018.sql
 - hf_labs-selected_results_agg-ALB_FULL-2018_patients.sql
 - hf_labs-selected_results_agg-ALB_FULL-2018_dx.sql
 - hf_labs-selected_results_agg-ALB_FULL-2018_pt_exclusion.sql
 - hf_labs-selected_results_agg-ALB_FULL-2018_pt_agegroup.sql
 - Export db table hf_f_lab_alb_2018 to hf_f_lab_alb_2018_out.tsv.
 - Export db table hf_f_lab_alb_2018_patients to hf_f_lab_alb_2018_patients_out.tsv.

## Read data file.

```{r echo=F}
ifile <- "oracle_hf_data/hf_f_lab_alb_2018_out.tsv"
...
```{r echo=F}
boi <- list("Albumin, Serum" = NULL, "Albumin Quant" = NULL)
# Entity metadata
boi_metadata <- list("Albumin, Serum" = list("entity_name" = "Albumin",
                                         "entity_type" = "Protein",
                                         "entity_id" = "P02768",
                                         "entity_id_source" = "UniProt"),
                     "Albumin Quant" = list("entity_name" = "Albumin",
                                         "entity_type" = "Protein",
                                         "entity_id" = "P02768",
                                         "entity_id_source" = "UniProt"))
i <- 0L
...
```{r echo=F}
ifile <- "oracle_hf_data/hf_f_lab_alb_2018_patients_out.tsv"
