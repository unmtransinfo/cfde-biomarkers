---
title: 'Oracle HealthFacts: Laboratory molecular biomarker results analysis: PSA biomarkers'
output:
  html_document:
    df_print: paged
...
Before running this workflow, the following steps are required, in order:
 ...
 - hf_labs-selected_results_agg-PSA_FULL-2018.sql
 - hf_labs-selected_results_agg-PSA_FULL-2018_patients.sql
 - hf_labs-selected_results_agg-PSA_FULL-2018_dx.sql
 - hf_labs-selected_results_agg-PSA_FULL-2018_pt_exclusion.sql
 - hf_labs-selected_results_agg-PSA_FULL-2018_pt_agegroup.sql
 - Export db table hf_f_lab_psa_2018 to hf_f_lab_PSA_2018_out.tsv.
 - Export db table hf_f_lab_psa_2018_patients to hf_f_lab_PSA_2018_patients_out.tsv.

## Read data file.

```{r echo=F}
ifile <- "oracle_hf_data/hf_f_lab_PSA_2018_out.tsv"
...
```{r echo=F}
boi <- list("PSA" = NULL, "PSA Free" = NULL)
# Entity metadata
boi_metadata <- list("PSA" = list("entity_name" = "Prostate-specific antigen",
                                         "entity_type" = "Protein",
                                         "entity_id" = "P07288",
                                         "entity_id_source" = "UPKB"),
                     "PSA Free" = list("entity_name" = "Prostate-specific antigen",
                                         "entity_type" = "Protein",
                                         "entity_id" = "P07288",
                                         "entity_id_source" = "UPKB"))
i <- 0L
...
```{r echo=F}
ifile <- "oracle_hf_data/hf_f_lab_PSA_2018_patients_out.tsv"
...
## Include only males, as prostate-cancer relevant.

```{r echo=F}
hf_pt <- hf_pt[gender == "Male"]
```
