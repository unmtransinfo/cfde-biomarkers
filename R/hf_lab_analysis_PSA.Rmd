...
Before running this workflow, the following steps are required:
...
sprintf("Patients (after exclusion): %d", hf_pt[, .N])
```
...
fig <- plot_ly(alpha = 0.8, xbins = list(size=5)) %>% 
	...
	layout(barmode = "group",
				 title = sprintf("Labs: (%s) cohort:<br>Histogram of patient count by age", paste(names(boi), collapse=", ")),
