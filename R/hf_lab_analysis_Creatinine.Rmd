...
report_stratstat[, `:=`(entity_name=entity_name, entity_type=entity_type, entity_id=entity_id, entity_id_source=entity_id_source)]
setcolorder(report_stratstat, c("entity_name", "entity_type", "entity_id", "entity_id_source"), before=1)
