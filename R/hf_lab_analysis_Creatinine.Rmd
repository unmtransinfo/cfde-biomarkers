...
# Entity metadata
boi_metadata <- list("Creatinine, Urine-Random" = list("entity_name" = "Creatinine",
                                         "entity_type" = "Metabolite",
                                         "entity_id" = "16737",
                                         "entity_id_source" = "CHEBI"),
                     "Creatinine, Urine Quant" = list("entity_name" = "Creatinine",
                                         "entity_type" = "Metabolite",
                                         "entity_id" = "16737",
                                         "entity_id_source" = "CHEBI"),
                     "Creatinine, Urine 24 hr" = list("entity_name" = "Creatinine",
                                         "entity_type" = "Metabolite",
                                         "entity_id" = "16737",
                                         "entity_id_source" = "CHEBI"))
i <- 0L
