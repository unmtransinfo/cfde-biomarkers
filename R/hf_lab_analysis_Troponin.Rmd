...
Also specify:
 - Entity Type, from BiomarkerKB ontology.
 - Entity ID and ID-source.
 
```{r echo=F}
boi <- list("Troponin I" = NULL, "Troponin T S/Pl" = NULL)
# Entity metadata
boi_metadata <- list("Troponin I" = list("entity_name" = "Troponin I",
                                         "entity_type" = "Protein",
                                         "entity_id" = "P19429",
                                         "entity_id_source" = "UPKB"),
                     "Troponin T S/Pl" = list("entity_name" = "Troponin T",
                                         "entity_type" = "Protein",
                                         "entity_id" = "P45379",
                                         "entity_id_source" = "UPKB"))
i <- 0L
for (lpm in names(boi)) {
  i <- i + 1
  message(sprintf("%d. Biomarker entity of interest: \"%s\"", i, lpm))
}
# Name of this biomarker group/topic.
boi_group_name <- "Troponin"
```
...
Also remove patients with age < 20 (too few, and normally not relevant to heart injury).
