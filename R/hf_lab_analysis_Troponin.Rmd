...
fig <- plot_ly(alpha = 0.8, xbins = list(size=5)) %>% 
	...
	layout(barmode = "group",
				 title = sprintf("Labs: (%s) cohort: Histogram of patient count by age & sex", paste(names(boi), collapse=", ")),
...
write_delim(report_stratstat[, .(lab, agegroup, sex, units, mean, median, sd, n)], ofile, "\t")
