...
Plots. Here we do a sample to avoid RStudio-freeze. See biomarkers_loinc_hf_results_analysis.R for full set.
...
for (i in 10:21) {
  ...
  plotname <- sprintf("%d. %s (%s)<br>%s", i_plot, gpid, units_preferred, lpmnemonic_preferred)
