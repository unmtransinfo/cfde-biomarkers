---
title: 'Oracle HealthFacts: Laboratory molecular biomarker results analysis: Alkaline Phosphatase (ALP) biomarkers'
output:
  html_document:
    df_print: paged
...
Before running this workflow, the following steps are required, in order:
 ...
 - hf_labs-selected_results_agg-ALP_FULL-2018.sql
 - hf_labs-selected_results_agg-ALP_FULL-2018_patients.sql
 - hf_labs-selected_results_agg-ALP_FULL-2018_dx.sql
 - hf_labs-selected_results_agg-ALP_FULL-2018_pt_exclusion.sql
 - hf_labs-selected_results_agg-ALP_FULL-2018_pt_agegroup.sql
 - Export db table hf_f_lab_alp_2018 to hf_f_lab_alp_2018_out.tsv.
 - Export db table hf_f_lab_alp_2018_patients to hf_f_lab_alp_2018_patients_out.tsv.

## Read data file.

```{r echo=F}
ifile <- "oracle_hf_data/hf_f_lab_alp_2018_out.tsv"
...
```{r echo=F}
boi <- list("Alk Phos, Serum" = NULL, "Alkaline Phosphatase Bone" = NULL)
# Entity metadata
boi_metadata <- list("Alk Phos, Serum" = list("entity_name" = "Alkaline Phosphatase",
                                         "entity_type" = "Protein",
                                         "entity_id" = "P10696",
                                         "entity_id_source" = "UniProt"),
                     "Alkaline Phosphatase Bone" = list("entity_name" = "Alkaline Phosphatase",
                                         "entity_type" = "Protein",
                                         "entity_id" = "P10696",
                                         "entity_id_source" = "UniProt"))
i <- 0L
...
```{r echo=F}
ifile <- "oracle_hf_data/hf_f_lab_alp_2018_patients_out.tsv"
...
### Before and after applying exclusion criteria (diagnosis related to diabetes, hyperglycemia, cancer).
### Before:
...
## Plot of patient counts by age and sex
...
```
Keep only "Alk Phos, Serum" and remove other labs due to lack of sufficient data.
