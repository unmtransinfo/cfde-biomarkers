---
title: 'Oracle HealthFacts: Laboratory molecular biomarker results analysis: Aspartate Aminotransferase (AST) biomarkers'
output:
  html_document:
    df_print: paged
...
Before running this workflow, the following steps are required, in order:
 ...
 - hf_labs-selected_results_agg-AST_FULL-2018.sql
 - hf_labs-selected_results_agg-AST_FULL-2018_patients.sql
 - hf_labs-selected_results_agg-AST_FULL-2018_dx.sql
 - hf_labs-selected_results_agg-AST_FULL-2018_pt_exclusion.sql
 - hf_labs-selected_results_agg-AST_FULL-2018_pt_agegroup.sql
 - Export db table hf_f_lab_ast_2018 to hf_f_lab_ast_2018_out.tsv.
 - Export db table hf_f_lab_ast_2018_patients to hf_f_lab_ast_2018_patients_out.tsv.

## Read data file.

```{r echo=F}
ifile <- "oracle_hf_data/hf_f_lab_ast_2018_out.tsv"
...
```{r echo=F}
boi <- list("AST/SGOT" = NULL, "AST/SGOT for Hep" = NULL)
# Entity metadata
boi_metadata <- list("AST/SGOT" = list("entity_name" = "Aspartate aminotransferase",
                                         "entity_type" = "Protein",
                                         "entity_id" = "Q2TU84",
                                         "entity_id_source" = "UniProt"),
                     "AST/SGOT for Hep" = list("entity_name" = "Aspartate aminotransferase",
                                         "entity_type" = "Protein",
                                         "entity_id" = "Q2TU84",
                                         "entity_id_source" = "UniProt"))
i <- 0L
...
```{r echo=F}
ifile <- "oracle_hf_data/hf_f_lab_ast_2018_patients_out.tsv"
...
### Before and after applying exclusion criteria (diagnosis related to diabetes, kidney disease, and liver disease).
### Before:
